	...
	factory: (require) => {
		...
		*/
		...
		var SelectionStore = class {
			...
			value;
			constructor(key = "dsh.sessions.current") {
				this.key = key;
			...
			*/
			...
			async reuseBlank(workspaceId, sessionId) {
				try {
					...
					if (error.rpcError?.code !== "session/writer-held") throw error;
			...
			startSession(workspaceId) {
				...
				this.openWorkspace(target).then(() => {}, (reason) => {
...
`;
		...
		function applyPinned(rows, pinnedOrder) {
		...
		function extractPinnedGroups(groups, pinnedOrder) {
			...
			const pinnedRows = /* @__PURE__ */ new Map();
			const remaining = [];
			for (const group of groups) {
				...
				if (kept.length > 0) remaining.push({
					...group,
					rows: kept
				});
			}
			return {
				pinned: pinnedOrder.flatMap((id) => {
		...
		*/
		...
		//#endregion
		//#region src/client/session-flags.ts
		...
		let pinnedOrder = readIds(PINNED_KEY);
		const pinnedListeners = /* @__PURE__ */ new Set();
		let unreadIds = readIds(UNREAD_KEY);
		...
		function togglePinned(id) {
			const next = pinnedOrder.includes(id) ? pinnedOrder.filter((item) => item !== id) : [id, ...pinnedOrder];
			pinnedOrder = next;
		...
		function subscribePinned(listener) {
		...
		*/
		...
		function SessionStatus({ row, unread }) {
		...
		function PinMark({ size = 12 }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				className: "ya-pin-mark",
				width: size,
				height: size,
				viewBox: "0 0 16 16",
				"aria-hidden": "true",
		...
		function SessionItem({ row, current, now, open, rename, fork, archive, t, context, actionMode, pinned, unread, paths, onOpenMenu, onReveal, onCopy }) {
			const [menuOpenButton, setMenuOpenButton] = (0, react.useState)(false);
			const [menuAt, setMenuAt] = (0, react.useState)(null);
			const menuOpen = menuOpenButton || menuAt !== null;
			const closeMenu = () => {
				setMenuOpenButton(false);
				setMenuAt(null);
			};
			...
			const actionIcon = isDelete ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconTrashOutlineRegular, {}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconArchiveOutlineRegular, { size: 16 });
			const hasCwd = row.cwd !== void 0;
			const pathsKnown = paths !== void 0;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionStatus, {
							row,
							unread
						})
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							children: [
								pinned && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PinMark, {}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					!row.blank && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
							...
							items: [
								{
									...
									icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PinMark, { size: 14 })
								},
								{
									id: "rename",
									label: t("rename"),
								...
								},
								{
									...
									icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconFolderOpenOutlineRegular, {}),
									disabled: !hasCwd
								},
								{
									id: "copy-path",
								...
								{
									id: "copy-dir",
									label: t("copySessionDir"),
									icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCopyOutlineRegular, {}),
									disabled: !pathsKnown || paths?.dir == null
								},
								{
									id: "copy-log",
									label: t("copyLogPath"),
									icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCopyOutlineRegular, {}),
									disabled: !pathsKnown || paths?.log == null
								},
								{
									id: "copy-id",
									label: t("copySessionId"),
									icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconLinkOutlineRegular, {})
								},
								{
									type: "separator",
									id: "sep-archive"
							...
							onSelect: (id) => {
								...
								if (id === "reveal" && row.cwd !== void 0) {
									onReveal(row.cwd);
									return;
								}
								if (id === "copy-path" && row.cwd !== void 0) {
									onCopy(row.cwd);
									return;
								}
								if (id === "copy-dir" && paths?.dir != null) {
									onCopy(paths.dir);
									return;
								}
								if (id === "copy-log" && paths?.log != null) {
									onCopy(paths.log);
									return;
								}
								if (id === "copy-id") {
		...
		function WorkspaceItem({ row, enter, create, reveal, copy, rename, remove, now, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutlineMedium, {}),
					row.real && menuAt !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
						open: true,
						onClose: () => {
							setMenuAt(null);
						},
						...
						onSelect: (id) => {
							setMenuAt(null);
							if (id === "create") create();
							if (id === "reveal" && row.path !== void 0) {
								reveal(row.path);
								return;
							}
							if (id === "copy-path" && row.path !== void 0) {
								copy(row.path);
								return;
							}
							if (id === "rename") rename();
		...
		function WorkspaceSidebar(props) {
			const { wide, expandSidebar, useSessions, useSessionStatus, useCurrentSession, useWorkspaces, startSession, open, searchSessions, searchResultLimit, renameSession, forkSession, renameWorkspace, deleteWorkspace, archiveSession, createWorkspace, useDirectoryFlow, renderSlot, t, resolveSessionPaths, revealInExplorer } = props;
			const sessions = useSessions((state) => state);
			const current = useCurrentSession((value) => value);
			const sessionsView = (0, react.useMemo)(() => ({
				...sessions,
				current
			}), [sessions, current]);
			...
			const pendingInteractions = useSessionStatus((state) => state);
			const directoryFlowAvailable = useDirectoryFlow((value) => value);
			const [pinnedOrder, setPinnedOrder] = (0, react.useState)(() => getPinnedOrder());
			const [unreadSet, setUnreadSet] = (0, react.useState)(() => getUnread());
			(0, react.useEffect)(() => subscribePinned(() => {
				setPinnedOrder(getPinnedOrder());
			}), []);
			(0, react.useEffect)(() => subscribeUnread(() => {
				setUnreadSet(getUnread());
			}), []);
			const pathsCache = (0, react.useRef)(/* @__PURE__ */ new Map());
			const [, setPathsTick] = (0, react.useState)(0);
			const prefetchPaths = (row) => {
				if (row.blank || pathsCache.current.has(row.id)) return;
				pathsCache.current.set(row.id, {
					dir: null,
					log: null
				});
				resolveSessionPaths({
			...
			const allRows = (0, react.useMemo)(() => deriveRecent(sessionsView, workspaces, archived, pendingInteractions, Number.MAX_SAFE_INTEGER), [
				archived,
				pendingInteractions,
				sessionsView,
				workspaces
			]);
			const recent = (0, react.useMemo)(() => applyPinned(allRows, pinnedOrder), [allRows, pinnedOrder]);
			const workspaceRows = (0, react.useMemo)(() => deriveWorkspaces(sessionsView, workspaces, archived), [
				archived,
				sessionsView,
				workspaces
			]);
			...
			(0, react.useEffect)(() => {
				...
				if (current !== void 0) {
					...
					setSelectedKey(workspaceKeyForSession(current, workspaces));
				}
			}, [current, workspaces]);
			(0, react.useEffect)(() => {
			...
			const levelGroups = (0, react.useMemo)(() => selectedKey !== null && selectedKey !== "__ya_ungrouped__" ? deriveWorkspaceSessionGroups(selectedKey, sessionsView, workspaces, archived, pendingInteractions, now) : [], [
				archived,
				pendingInteractions,
				sessionsView,
				workspaces,
			...
			const levelPinned = (0, react.useMemo)(() => extractPinnedGroups(levelGroups, pinnedOrder), [levelGroups, pinnedOrder]);
			const levelRows = (0, react.useMemo)(() => applyPinned(selectedKey === "__ya_ungrouped__" ? deriveWorkspaceSessions(UNGROUPED, sessionsView, workspaces, archived, pendingInteractions) : [], pinnedOrder), [
				archived,
				pendingInteractions,
				sessionsView,
				workspaces,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								children: actionMode === "delete" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconTrashOutlineRegular, { size: wide ? 16 : 18 }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconArchiveOutlineRegular, { size: wide ? 16 : 18 })
							}),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								"aria-label": t("search"),
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconSearchOutlineRegular, { size: wide ? 14 : 18 })
							}),
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("recent") }), recent.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										...
										children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutlineMedium, {})
									})]
								...
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										selectedKey === null ? workspaceGroups.flatMap((group) => [...group.dateKey === "" ? [] : [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											...
											now,
											t
										}, row.key))]) : selectedKey === "__ya_ungrouped__" ? levelRows.map((row) => sessionItem(row, false)) : [
											...levelPinned.pinned.length > 0 ? [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
												className: "ya-date-group-label",
												role: "separator",
												children: t("pinnedGroup")
											}, "group-pinned")] : [],
											...levelPinned.pinned.map((row) => sessionItem(row, false)),
											...levelPinned.groups.flatMap((group) => [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
												className: "ya-date-group-label",
												role: "separator",
												children: dateGroupLabel(group, now, t)
